...
values(2016,'2016-08-05','2016-08-21',31,'Brazylia','Rio','Tom'),
	  ...
	  (1996,'1966-07-19','1996-08-04',26,'USA','Atalanta','Trójz¹b'),
	  ...
	  (1980,'1980-07-19','1980-08-03',22,'Zwi¹zek Radziecki','Moskwa','Mróz');
...
('Estádio Olímpico de Canoagem Slalom',8000,'Rio'),
...
('Koszykówka','Koszykówka',null),
('Styl Klasyczny kobiet 100m','P³ywanie',68),
('Uje¿d¿enie','JeŸdziectwo',92),
('Pi³ka Rêczna','Pi³ka Rêczna',null),
...
(2016,'Estádio Olímpico de Canoagem Slalom','Boks');
...
INSERT INTO dbo.OBIEKT values('Estadio Olimpico',1,'Rio'); /*powtórzony primary key*/
INSERT INTO dbo.KLASYFIKACJA values(2016,null,10.84,1); /*miejsce nie mo¿e byæ nullem*/
