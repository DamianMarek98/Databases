...
CREATE TABLE KLASYFIKACJA (
	NUMER INTEGER PRIMARY KEY IDENTITY(1,1),
	NUMER_ROZEGRANIA INTEGER FOREIGN KEY (NUMER_ROZEGRANIA) REFERENCES ROZEGRANIE(NR) ON UPDATE CASCADE ON DELETE CASCADE ,
...
NUMER INTEGER IDENTITY(1,1) PRIMARY KEY,
 ROK INTEGER NOT NULL,
 LICZNOSC_DRUZYNY INTEGER NOT NULL,
 NAZWA_KONKURENCJI VARCHAR(255) NOT NULL,
 NAZWA_NARODOWOSCI VARCHAR(255) NOT NULL,
 FOREIGN KEY (ROK) REFERENCES IGRZYSKA(ROK) ON UPDATE CASCADE ON DELETE CASCADE,
